    ...
    <main id="top" className="overflow-hidden">
      ...
      <section className="container-page flex min-h-screen items-center pb-16 pt-28 lg:pt-36">
        <div className="grid w-full items-end gap-10 lg:grid-cols-12 lg:gap-12">
          <div className="relative z-10 lg:col-span-7 lg:pb-8">
            ...
            <h1 className="display text-[clamp(4.25rem,10vw,9.5rem)]">Manar<br /><span className="ml-[10vw] italic text-gold lg:ml-24">Kabbara</span></h1>
            ...
            <div className="mt-9 flex flex-wrap gap-3">
              <a href="#architecture" className="bg-ink px-5 py-3 text-[11px] font-semibold uppercase tracking-wider text-white transition hover:bg-gold">Architecture work</a>
              <a href="#graphic-design" className="border border-ink/20 px-5 py-3 text-[11px] font-semibold uppercase tracking-wider transition hover:border-ink">Graphic design</a>
              <a href="#contact" className="px-3 py-3 text-[11px] font-semibold uppercase tracking-wider text-gold">Contact ↘</a>
            </div>
          </div>
      ...
      <section id="graphic-design" className="scroll-mt-24 bg-white py-24 lg:py-36">
        <div className="container-page">
          ...
          <FeaturedProject project={graphicProjects[0]} />
          <div>{graphicProjects.slice(1, 2).map((project, i) => <ProjectCard key={project.title} project={project} dark={i === 0} />)}</div>
        </div>
      </section>
      ...
      <footer className="border-t border-paper/10 bg-ink py-6 text-paper/40">
        <div className="container-page flex flex-col gap-2 text-[10px] uppercase tracking-[0.16em] sm:flex-row sm:items-center sm:justify-between"><p>© 2026 Manar Kabbara</p><p>Architecture & Graphic Design Portfolio</p></div>
      </footer>
    </main>
  );
}
