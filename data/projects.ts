...
export const graphicProjects: Project[] = [
  ...
  },
  {
    ...
    images: [
      { src: "/projects/graphic-design/dandashi-foundation/main-visual.jpg", label: "Foundation educational event visual" },
      { src: "/projects/graphic-design/dandashi-foundation/campaign-design.jpg", label: "Campaign design and institutional greeting" },
      { src: "/projects/graphic-design/dandashi-foundation/promotional-material.jpg", label: "Promotional communication material" },
    ],
  },
  {
    number: "03",
    ...
    overview: "A visual communication and event media project supporting TEDxAlqassa through digital content, event communication materials, and media coverage assets.",
    concept: "The work maintains a clear and engaging TEDx visual presence while supporting audience engagement, event storytelling, and consistent communication across digital touchpoints.",
    role: ["Graphic Design", "Visual Communication", "Social Media Content", "Event Documentation", "Media Support"],
    keyPoints: ["TEDx event visual communication", "Event branding support", "Social media design", "Audience engagement materials", "Consistent identity application"],
    tags: ["Event Branding", "TEDx", "Social Media"],
    images: [
      { src: "/projects/graphic-design/tedx-alqassa/main-visual.jpg", label: "TEDxAlqassa main event visual" },
      { src: "/projects/graphic-design/tedx-alqassa/event-branding.jpg", label: "Event branding and visual consistency" },
      { src: "/projects/graphic-design/tedx-alqassa/social-media-design.jpg", label: "Social media communication design" },
      { src: "/projects/graphic-design/tedx-alqassa/event-documentation.jpg", label: "Event media and documentation asset" },
      { src: "/projects/graphic-design/tedx-alqassa/communication-material.jpg", label: "Communication and audience engagement material" },
    ],
  },
  {
    number: "04",
    title: "Event & Print Design Collection",
    category: "Event Communication, Print Design & Visual Materials",
    overview: "A curated collection of event and print design works, including identification badges, certificates, and communication materials developed for academic and professional initiatives.",
    concept: "The collection focuses on practical visual communication across printed and digital formats, using clean hierarchy, consistent spacing, and print-ready organization to support real event needs.",
    role: ["Graphic Design", "Print Design", "Event Communication Materials", "Certificate Design", "Identification Badge Design", "Layout Design", "Visual Communication"],
    keyPoints: ["Identification badge design", "Certificate layout system", "Formal typography and spacing", "Print-ready organization", "Academic event communication"],
    tags: ["Print Design", "Events", "Layout"],
    images: [
      { src: "/projects/graphic-design/event-print-design/main-visual.jpg", label: "Certificate design and formal print layout" },
      { src: "/projects/graphic-design/event-print-design/badges-design.jpg", label: "Identification badge design and event hierarchy" },
    ],
  },
  {
    number: "05",
